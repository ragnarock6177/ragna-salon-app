...
import {
  ...
  Ban, Eye,
  MapPin, CheckCircle, EyeOff, ArrowLeft, Camera, Upload, Image, Download, QrCode
} from 'lucide-angular';
...
const usedIcons = {
  ...
  User, Mail, Star, Sparkles, Ban, Eye, MapPin, CheckCircle, EyeOff, ArrowLeft, Camera, Upload, Image, Download, QrCode
};
